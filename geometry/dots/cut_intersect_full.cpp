...
int main()
{
    ...
    else
    {
        if (inparalel(cut_1_start, cut_1_finish, cut_2_start, cut_2_finish))
        {
            ...
            cout << fixed << setprecision(6) << intersect_point.x << ' ' << intersect_point.y;
        }
        else
        {
            ...
            if (is_equal(intersect_start.x, intersect_finish.x) &&
                ...
                cout << fixed << setprecision(6) << intersect_start.x << ' ' << intersect_start.y;
            else
            {
                if (comp(intersect_start, intersect_finish)) swap(intersect_start, intersect_finish);
                cout << fixed << setprecision(6) << intersect_start.x << ' ';
                cout << fixed << setprecision(6) << intersect_start.y << '\n';
                cout << fixed << setprecision(6) << intersect_finish.x << ' ';
                cout << fixed << setprecision(6) << intersect_finish.y;
            }
        }
    }
}
